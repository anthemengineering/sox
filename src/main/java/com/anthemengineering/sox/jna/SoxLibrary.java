...
public interface SoxLibrary extends Library {
	 ...
	 * @return The version number string of libSoX, for example, "14.4.0".
	 ...
	 * @return Pointer to a version information structure.<br>
	 ...
	 * @return a pointer to the structure with libSoX's global settings.<br>
	 ...
	 * @return pointer to the list of available encodings.<br>
	 ...
	 * @return the number of useful bits per sample in the decoded data (for example<br>
	 ...
	 * @return the number of items in the metadata block.<br>
	 ...
	 * @return the copied metadata block.<br>
	 ...
	 * @return value, or null if value not found.<br>
	 ...
	 * @return SOX_SUCCESS if successful.<br>
	 ...
	 * @return the table of format handler names and functions.<br>
	 ...
	 * @return The handle for the new session, or null on failure.<br>
	 ...
	 * @return true if the format handler for the specified file type supports the specified encoding.<br>
	 ...
	 * @return The found format handler, or null if not found.<br>
	 ...
	 * @return The new session handle, or null on failure.<br>
	 ...
	 * @param overwrite_permitted overwrite_permitted
	 ...
	 * @return Number of samples decoded, or 0 for EOF.<br>
	 ...
	 * @return Number of samples encoded.<br>
	 ...
	 * @return Format handler data, or null if not found.<br>
	 ...
	 * @return global parameters for effects.<br>
	 ...
	 * @return Effect pointer, or null if not found.<br>
	 ...
	 * @return The new effect, or null if not found.<br>
	 ...
	 * @return the number of arguments consumed.<br>
	 ...
	 */
	int sox_effect_options(sox_effect_t effp, int argc, Pointer[] argv);
	/**
	 * Client API:<br>
	 * Applies the command-line options to the effect.<br>
	 * @return the number of arguments consumed.<br>
	 ...
	 * @return An array containing the known effect handlers.<br>
	 ...
	 * @return Handle, or null on failure.<br>
	 ...
	 * @return the number of clips that occurred while running an effects chain.<br>
	 ...
	 * @return the number of clips from all flows.<br>
	 ...
	 * @return the removed effect, or null if no effects.<br>
	 ...
	 * clear trim start).<br>
	 * @return the sample offset of the start of the trim.<br>
	 ...
	 * @return true if the specified file is a known playlist file type.<br>
	 ...
	 * @return error string corresponding to the specified error code,<br>
	 ...
	 * @return the number of characters written to base_buffer, excluding the null,<br>
	 * or 0 on failure.<br>
	 ...
	 * @return the corresponding item, or null if not found.<br>
	 ...
	 * @return The enumeration value corresponding to the matching enumeration, or<br>
	 ...
	 * @return true if the specified string ends with the specified suffix.<br>
	 ...
	 * @return the file extension, not including the '.', or null if filename does<br>
	 ...
	 * @return A static buffer with the formatted number, valid until the next time<br>
	 ...
	 * @return New buffer, or null if buffer was freed.<br>
	 ...
	 * @return 0 (s1 == s2), negative (s1 &lt; s2), or positive (s1 &gt; s2).<br>
	 ...
	 * @return option character (short), val or 0 (long), or -1 (no more).<br>
	 ...
	 * @return The file length, or 0 if the file is not seekable/normal.<br>
	 * Original signature : <code>sox_uint64_t lsx_filelength(sox_format_t*)</code><br>
	 * @param ft see sox_format_t
